...
namespace jp.nyatla.nyartoolkit.cs.markersystem
{
    ...
    public class NyARMarkerSystem
    {
         ...
         * 定数値。敷居値を自動決定します。 
         */
        public static int THLESHOLD_AUTO = 0x7fffffff;
        ...
        public int addNyIdMarker(long i_id, double i_marker_size)
        {
            ...
            this._rledetect._idmk_list.Add(target);
            this._rledetect._tracking_list.Add(target);
            return (this._rledetect._idmk_list.Count - 1) | IDTYPE_NYID;
        }
        /**
        ...
        public int addARMarker(NyARCode i_code, int i_patt_edge_percentage, double i_marker_size)
        {
            ...
            this._rledetect._armk_list.Add(target);
            this._rledetect._tracking_list.add(target);
            return (this._rledetect._armk_list.Count - 1) | IDTYPE_ARTK;
        }
        /**
        ...
        public double getConfidence(int i_id)
        {
            ...
            {
                //ARマーカ
                return this._rledetect._armk_list[i_id & MASK_IDNUM].cf;
            }
            //Idマーカ？
        ...
        public long getNyId(int i_id)
        {
            ...
            {
                //Idマーカ
                return this._rledetect._idmk_list[i_id & MASK_IDNUM].nyid;
            }
            //ARマーカ？
            throw new NyARException();
        }
        ...
        public long getLife(int i_id)
        {
            ...
            {
                //ARマーカ
                return this._rledetect._armk_list[i_id & MASK_IDNUM].life;
            }
            else
            {
                //Idマーカ
                return this._rledetect._idmk_list[i_id & MASK_IDNUM].life;
            }
        }
        /**
        ...
        public long getLostCount(int i_id)
        {
            ...
            {
                //ARマーカ
                return this._rledetect._armk_list[i_id & MASK_IDNUM].lost_count;
            }
            else
            {
                //Idマーカ
                return this._rledetect._idmk_list[i_id & MASK_IDNUM].lost_count;
            }
        }
        /**
        ...
        public NyARDoubleMatrix44 getMarkerMatrix(int i_id)
        {
            ...
            {
                //ARマーカ
                return this._rledetect._armk_list[i_id & MASK_IDNUM].tmat;
            }
            else
            {
                //Idマーカ
                return this._rledetect._idmk_list[i_id & MASK_IDNUM].tmat;
            }
        }
        /**
        ...
        public NyARIntPoint2d[] getMarkerVertex2D(int i_id)
        {
            ...
            {
                //ARマーカ
                return this._rledetect._armk_list[i_id & MASK_IDNUM].tl_vertex;
            }
            else
            {
                //Idマーカ
                return this._rledetect._idmk_list[i_id & MASK_IDNUM].tl_vertex;
            }
        }
        /**
         * この関数は、2値化敷居値を設定します。
    ...
    class RleDetector : NyARSquareContourDetector_Rle
    {
        ...
        public RleDetector(INyARMarkerSystemConfig i_config)
            : base(i_config.getNyARParam().getScreenSize())
        {
        ...
        public void detectMarker(NyARSensor i_sensor, long i_time_stamp, int i_th)
        {
            ...
            base.detectMarker(this._ref_input_gs, i_th);
