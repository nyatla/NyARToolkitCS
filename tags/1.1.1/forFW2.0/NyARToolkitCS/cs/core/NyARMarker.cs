...
namespace jp.nyatla.nyartoolkit.cs.core
{
     ...
     * 
     */
    public class NyARMarker
    {
        /**
         * メモリブロックのサイズ(32*4=128kb)
         */
        private const int ALLOCATE_PAGE_SIZE=256;
        /**
         * メモリブロックの初期サイズ
         */
        private const int INITIAL_SIZE=1;
        public int[] x_coord = new int[INITIAL_SIZE];
        public int[]	y_coord=new int[INITIAL_SIZE];
        public int coord_num;
        public int area;
        public double[] pos=new double[2];
        public int[] mkvertex = new int[5];
        /**
...
//            System.arraycopy(i_xcoord, 0, x_coord, i_coord_num - i_v1, i_v1);
            Array.Copy(i_xcoord, i_v1, x_coord, 0, i_coord_num - i_v1);
            Array.Copy(i_xcoord, 0, x_coord, i_coord_num - i_v1, i_v1);
...
//            System.arraycopy(i_ycoord, 0, y_coord, i_coord_num - i_v1, i_v1);
            Array.Copy(i_ycoord, i_v1, y_coord, 0, i_coord_num - i_v1);
            Array.Copy(i_ycoord, 0, y_coord, i_coord_num - i_v1, i_v1);
        ...
        private NyARVertexCounter wk_checkSquare_wv1=new NyARVertexCounter();
        private NyARVertexCounter wk_checkSquare_wv2=new NyARVertexCounter();
        /**
         ...
         * @return
         */
        public bool checkSquare(int i_area,double i_factor,double i_pos_x,double i_pos_y)
        {
	        int[] l_vertex=mkvertex;
	        int[] l_x_coord=x_coord;
	        int[] l_y_coord=y_coord;
	        NyARVertexCounter wv1=wk_checkSquare_wv1;
	        NyARVertexCounter wv2=wk_checkSquare_wv2;
	        int             sx,sy;
	        int             dmax,d,v1;
	        ...
	        double thresh = (i_area/0.75) * 0.01 * i_factor;
