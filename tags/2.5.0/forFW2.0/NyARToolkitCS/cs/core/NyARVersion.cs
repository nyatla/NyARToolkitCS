...
namespace jp.nyatla.nyartoolkit.cs.core
{
    ...
    {
        private const int AR_HEADER_VERSION_MAJOR = 2; //#define AR_HEADER_VERSION_MAJOR		2
        private const int AR_HEADER_VERSION_MINOR = 72;//#define AR_HEADER_VERSION_MINOR		72   
