...
namespace jp.nyatla.nyartoolkit.cs.core
{
    ...
    public class Coord2SquareVertexIndexes
    {
         ...
         * @return
         */
        public bool getVertexIndexes(int[] i_x_coord, int[] i_y_coord, int i_coord_num, int i_area, int[] o_vertex)
        {
    ...
    {
        public int[] vertex = new int[10];// 6まで削れる
        ...
        public bool getVertex(int[] i_x_coord, int[] i_y_coord, int i_coord_len, int st, int ed, double i_thresh)
        {
