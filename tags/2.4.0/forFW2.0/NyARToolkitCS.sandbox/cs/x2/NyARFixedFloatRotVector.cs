...
namespace jp.nyatla.nyartoolkit.cs.sandbox.x2
{
    class NyARFixedFloatRotVector
    {
        ...
        public NyARFixedFloatRotVector(NyARPerspectiveProjectionMatrix i_cmat)
        {
            ...
            //FixedFloat16にコピー
            this._cmat.m00 = (long)(i_cmat.m00 * NyMath.FIXEDFLOAT16_1);
            this._cmat.m01 = (long)(i_cmat.m01 * NyMath.FIXEDFLOAT16_1);
            this._cmat.m02 = (long)(i_cmat.m02 * NyMath.FIXEDFLOAT16_1);
            this._cmat.m10 = (long)(i_cmat.m10 * NyMath.FIXEDFLOAT16_1);
            this._cmat.m11 = (long)(i_cmat.m11 * NyMath.FIXEDFLOAT16_1);
            this._cmat.m12 = (long)(i_cmat.m12 * NyMath.FIXEDFLOAT16_1);
            this._cmat.m20 = (long)(i_cmat.m20 * NyMath.FIXEDFLOAT16_1);
            this._cmat.m21 = (long)(i_cmat.m21 * NyMath.FIXEDFLOAT16_1);
            this._cmat.m22 = (long)(i_cmat.m22 * NyMath.FIXEDFLOAT16_1);
         ...
         * @param cpara
         */
        public void checkVectorByVertex(NyARFixedFloat16Point2d i_start_vertex, NyARFixedFloat16Point2d i_end_vertex)
        {
            long h;
            double[][] inv_cpara = this._inv_cpara_array_ref;
            double stx = (double)(i_start_vertex.x / NyMath.FIXEDFLOAT16_1);
            double sty = (double)(i_start_vertex.y / NyMath.FIXEDFLOAT16_1);

            //final double[] world = __checkVectorByVertex_world;// [2][3];
            long world0 = (long)((inv_cpara[0][0] * stx + inv_cpara[0][1] * sty + inv_cpara[0][2]) * 10.0 * NyMath.FIXEDFLOAT16_1);// mat_a->m[0]*st[0]*10.0+
            long world1 = (long)((inv_cpara[1][0] * stx + inv_cpara[1][1] * sty + inv_cpara[1][2]) * 10.0 * NyMath.FIXEDFLOAT16_1);// mat_a->m[3]*st[0]*10.0+
            long world2 = (long)((inv_cpara[2][0] * stx + inv_cpara[2][1] * sty + inv_cpara[2][2]) * 10.0 * NyMath.FIXEDFLOAT16_1);// mat_a->m[6]*st[0]*10.0+
            long world3 = world0 + (this.v1);
            long world4 = world1 + (this.v2);
            long world5 = world2 + (this.v3);
            // </Optimize>
            ...
            long camera0 = (this._cmat.m00 * world0 + this._cmat.m01 * world1 + this._cmat.m02 * world2) / h;
            long camera1 = (this._cmat.m10 * world0 + this._cmat.m11 * world1 + this._cmat.m12 * world2) / h;
            ...
            long camera2 = (this._cmat.m00 * world3 + this._cmat.m01 * world4 + this._cmat.m02 * world5) / h;
            long camera3 = (this._cmat.m10 * world3 + this._cmat.m11 * world4 + this._cmat.m12 * world5) / h;
         ...
         */
	public static void checkRotation(NyARFixedFloatRotVector io_vec1, NyARFixedFloatRotVector io_vec2)
	{
		long w;
		int f;
		...
		long ca = (NyMath.sqrtFixdFloat16(cb + NyMath.FIXEDFLOAT16_1) + NyMath.sqrtFixdFloat16(NyMath.FIXEDFLOAT16_1 - cb)) >>1;
