...
namespace jp.nyatla.nyartoolkit.cs.core
{
    public abstract class NyARSquareContourDetector_ARToolKit : NyARSquareContourDetector
    {
	    ...
	    private NyARLabelOverlapChecker<NyARLabelingLabel> _overlap_checker = new NyARLabelOverlapChecker<NyARLabelingLabel>(32);
	    private NyARContourPickup_ARToolKit _cpickup=new NyARContourPickup_ARToolKit();
