...
namespace jp.nyatla.nyartoolkit.cs.nyidmarker
{
    ...
    public class NyIdMarkerPickup
    {
	     ...
	     * @throws NyARException
	     */
	    public bool pickFromRaster(INyARRgbRaster image, NyARDoublePoint2d[] i_vertex,NyIdMarkerPattern o_data,NyIdMarkerParam o_param)
	    {
		    //遠近法のパラメータを計算
	     ...
	     * @throws NyARException
	     */
	    private bool _pickFromRaster(INyARRgbRaster image, NyIdMarkerPattern o_data,NyIdMarkerParam o_param)
	    {
