...
namespace jp.nyatla.nyartoolkit.cs.core
{
    ...
    //	}
        ...
        private const int AR_CHAIN_MAX=10000;
        private int[] wk_arGetContour_xdir={0,  1, 1, 1, 0,-1,-1,-1};
        private int[] wk_arGetContour_ydir={-1,-1, 0, 1, 1, 1, 0,-1};
        private int[] wk_arGetContour_xcoord=new int[AR_CHAIN_MAX];
        private int[] wk_arGetContour_ycoord=new int[AR_CHAIN_MAX];
        /**
         ...
         */
        private void arGetContour(NyARMarker o_marker,int[,] limage, int[] label_ref,int i_labelnum, NyARLabel i_label)
        {
	        int[] xcoord=wk_arGetContour_xcoord;
	        int[] ycoord=wk_arGetContour_ycoord;
	        int[] xdir=wk_arGetContour_xdir; //static int      xdir[8] = { 0, 1, 1, 1, 0,-1,-1,-1};
	        int[] ydir=wk_arGetContour_ydir;//static int      ydir[8] = {-1,-1, 0, 1, 1, 1, 0,-1};
...
//	        limage_j=limage[j];
         ...
         * @throws NyARException
         */
        public void detectMarker(NyARLabeling i_labeling,double i_factor,NyARMarkerList o_marker_list)
        {
	        int label_area;
	        int i;
	        int xsize, ysize;
