...
namespace jp.nyatla.nyartoolkit.cs.sandbox.x2
{
    public class NyMath
    {
	public const long FIXEDFLOAT24_1=0x1000000L;
	public const long FIXEDFLOAT24_0_25=FIXEDFLOAT24_1/4;
	public const long FIXEDFLOAT16_1=0x10000L;	
	public const long FIXEDFLOAT16_0_25=FIXEDFLOAT16_1/4;	
	public const long FIXEDFLOAT8_1=0x100L;
	
	private const int FIXEDFLOAT16I_1=(int)FIXEDFLOAT16_1;	
	private const int FIXEDFLOAT16I_0_25=(int)FIXEDFLOAT16_1/4;	
	
	
	

	private const int FF16_PI=(int)(Math.PI*FIXEDFLOAT16_1);
	private const int FF16_2PI=(int)(2 *FF16_PI);
	private const int FF16_05PI=(int)(FF16_PI/2);
	/* sinテーブルは0-2PIを1024分割
	 * acosテーブルは0-1を256分割
	 */
	private static int[] sin_table=new int[339];
	private static int[] acos_table=new int[1537];
    private const int SQRT_LOOP = 10;
	/**
