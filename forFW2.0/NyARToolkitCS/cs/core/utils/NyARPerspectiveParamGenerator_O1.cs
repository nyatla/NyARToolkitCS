...
public class NyARPerspectiveParamGenerator_O1 : NyARPerspectiveParamGenerator
{
	 ...
	 */
	public sealed bool getParam(int i_dest_w,int i_dest_h,double x1,double y1,double x2,double y2,double x3,double y3,double x4,double y4,double[] o_param)throws NyARException
	{
