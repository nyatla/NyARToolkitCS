...
public class NyARIntSize
{
	 ...
	 * {@link #h}に設定する値
	 */
	public sealed void setValue(int i_w,int i_h)
	{
		this.w=i_w;
		this.h=i_h;
		return;
	 ...
	 */
	public sealed bool isEqualSize(int i_width, int i_height)
	{
	 ...
	 * @throws NyARException
	 */
	public sealed bool isEqualSize(NyARIntSize i_size)
	{
	 ...
	 * @throws NyARException
	 */
	public sealed bool isInnerSize(int i_x,int i_y)
	{
	 ...
	 * @throws NyARException
	 */
	public sealed bool isInnerSize(NyARIntSize i_size)
	{
	 ...
	 * @throws NyARException
	 */
	public sealed bool isInnerSize(NyARDoublePoint2d i_point)
	{
