...
public class NyARVecLinear2d
{
	 ...
	 */
	public sealed void normalVec(NyARVecLinear2d i_src)
	{
		double w=this.dx;
		this.dx=i_src.dy;
		this.dy=-w;
	 ...
	 * コピー元のオブジェクト
	 */
	public sealed void setValue(NyARVecLinear2d i_value)
	{
		this.dx=i_value.dx;
		this.dy=i_value.dy;
		this.x=i_value.x;
	 ...
	 * ２直線のCOS値（radian）
	 */
	public sealed double getVecCos(NyARVecLinear2d i_v1)
	{
		double x1=i_v1.dx;
		double y1=i_v1.dy;
		double x2=this.dx;
	 ...
	 * ２直線のCOS値の絶対値（radian）
	 */
	public sealed double getAbsVecCos(NyARVecLinear2d i_v1)
	{
	 ...
	 * ２直線のCOS値（radian）
	 */
	public sealed double getVecCos(double i_dx,double i_dy)
	{
		double x1=this.dx;
		double y1=this.dy;
	 ...
	 * ２直線のCOS値の絶対値（radian）
	 */
	public sealed double getAbsVecCos(double i_v2_x,double i_v2_y)
	{
	 ...
	 * ２直線のCOS値（radian）
	 */
	public sealed double getVecCos(NyARDoublePoint2d i_pos1,NyARDoublePoint2d i_pos2)
	{
	 ...
	 * ２直線のCOS値の絶対値（radian）
	 */
	public sealed double getAbsVecCos(NyARDoublePoint2d i_pos1,NyARDoublePoint2d i_pos2)
	{
	 ...
	 * 交点が求まると、trueを返します。
	 */
	public sealed bool crossPos(NyARVecLinear2d i_vector1,NyARDoublePoint2d o_point)
	{
	 ...
	 * 計算に成功すると、trueを返します。
	 */
	public sealed bool leastSquares(NyARDoublePoint2d[] i_points,int i_number_of_data)
	{
		int i;
	 ...
	 * 計算に成功すると、trueを返します。
	 */
	public sealed bool leastSquaresWithNormalize(NyARDoublePoint2d[] i_points,int i_number_of_data)
	{
