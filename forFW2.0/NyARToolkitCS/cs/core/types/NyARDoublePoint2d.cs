...
public class NyARDoublePoint2d
{
	 ...
	 * 外積の値
	 */
	public sealed static double crossProduct3Point(NyARDoublePoint2d p1,NyARDoublePoint2d p2,NyARDoublePoint2d p3)
	{
	 ...
	 * 外積の値
	 */
	public sealed static double crossProduct3Point(NyARDoublePoint2d p1,NyARDoublePoint2d p2,double p3_x,double p3_y)
	{
	 ...
	 * 中央値を受け取るオブジェクトです。
	 */
	public sealed static void makeCenter(NyARDoublePoint2d[] i_points,int i_number_of_data,NyARDoublePoint2d o_out)
	{
		double x,y;
		x=y=0;
	 ...
	 * 中央値を受け取るオブジェクトです。
	 */
	public sealed static void makeCenter(NyARDoublePoint2d[] i_points,int i_number_of_data,NyARIntPoint2d o_out)
	{
		double lx,ly;
		lx=ly=0;
		for(int i=i_number_of_data-1;i>=0;i--)
	 ...
	 * i_p1との距離の二乗値
	 */	
	public sealed double sqDist(NyARDoublePoint2d i_p1)
	{
		double x,y;
		x=this.x-i_p1.x;
		y=this.y-i_p1.y;
	 ...
	 * i_p1との距離の二乗値
	 */	
	public sealed double sqDist(NyARIntPoint2d i_p1)
	{
		double x,y;
		x=this.x-i_p1.x;
		y=this.y-i_p1.y;
	 ...
	 * コピー元のオブジェクト。
	 */
	public sealed void setValue(NyARDoublePoint2d i_src)
	{
		this.x=i_src.x;
		this.y=i_src.y;
		return;
	 ...
	 * コピー元のオブジェクト。
	 */
	public sealed void setValue(NyARIntPoint2d i_src)
	{
		this.x=(double)i_src.x;
		this.y=(double)i_src.y;
		return;
	 ...
	 * {@link #y}にセットする値
	 */
	public sealed void setValue(double i_x,double i_y)
	{
		this.x=i_x;
		this.y=i_y;
		return;
