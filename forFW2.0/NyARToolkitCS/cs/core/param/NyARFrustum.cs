...
public class NyARFrustum
{
	 ...
	 * 撮像点座標
	 */
	public sealed void unProject(double ix,double iy,NyARDoublePoint3d o_point_on_screen)
	{
	 ...
	 * 結果を受け取るオブジェクトです。
	 */
	public sealed void unProjectOnCamera(double ix,double iy,NyARDoubleMatrix44 i_mat,NyARDoublePoint3d o_pos)
	{
		//画面→撮像点
	 ...
	 * 計算に成功すると、trueを返します。
	 */
	public sealed bool unProjectOnMatrix(double ix,double iy,NyARDoubleMatrix44 i_mat,NyARDoublePoint3d o_pos)
	{
		//交点をカメラ座標系で計算
	 ...
	 * 結果を受け取るオブジェクトです。
	 */
	public sealed void project(double i_x,double i_y,double i_z,NyARDoublePoint2d o_pos2d)
	{
	 ...
	 * 結果を受け取るオブジェクトです。
	 */
	public sealed void project(NyARDoublePoint3d i_pos,NyARDoublePoint2d o_pos2d)
	{
	 ...
	 */
	public sealed NyARDoubleMatrix44 getMatrix()
	{
	 ...
	 */
	public sealed NyARDoubleMatrix44 getInvMatrix()
	{
