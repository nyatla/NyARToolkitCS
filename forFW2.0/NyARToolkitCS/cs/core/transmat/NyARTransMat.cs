...
{	
	 ...
	 */
	private sealed void initInstance(NyARCameraDistortionFactor i_distfactor,NyARPerspectiveProjectionMatrix i_projmat)
	{
...
//			System.out.println("TR:again");
	 ...
	 * @throws NyARException
	 */
	public sealed double errRate(NyARDoubleMatrix33 i_rot,NyARDoublePoint3d i_trans, NyARDoublePoint3d[] i_vertex3d, NyARDoublePoint2d[] i_vertex2d,int i_number_of_vertex,NyARDoublePoint3d[] o_rot_vertex)
	{
		NyARPerspectiveProjectionMatrix cp = this._ref_projection_mat;
		sealed double cp00=cp.m00;
		sealed double cp01=cp.m01;
		sealed double cp02=cp.m02;
		sealed double cp11=cp.m11;
		sealed double cp12=cp.m12;
