...
namespace jp.nyatla.nyartoolkit.cs.core
{
     ...
     *
     */
    public class NyARTransMat_O2 : NyARTransMat
    {
        private const int AR_FITTING_TO_IDEAL=0;//#define  AR_FITTING_TO_IDEAL          0
        private const int AR_FITTING_TO_INPUT=1;//#define  AR_FITTING_TO_INPUT          1
        private const int	arFittingMode	=AR_FITTING_TO_INPUT;
        ...
        private const int P_MAX=10;//頂点の数(4で十分だけどなんとなく10)//#define P_MAX       500
        private const int NUMBER_OF_VERTEX=4;//処理対象の頂点数
        private NyARTransRot transrot;
         ...
         * @param o_ppos3d
         */
        private void init_transMat_ppos(NyARSquare square,int i_direction,double i_width,double[,] o_ppos2d,double[,] o_ppos3d)
        {	
        ...
        private double[,] wk_transMat_pos3d=new double[P_MAX,3];//pos3d[P_MAX][3];
        private double[,] wk_transMat_ppos2d=new double[4,2];
        private double[,] wk_transMat_ppos3d=new double[4,2];
        private double[] wk_transMat_off=new double[3];
        private double[,] wk_transMat_pos2d=new double[P_MAX,2];//pos2d[P_MAX][2];
        private NyARMat wk_transMat_mat_b=new NyARMat(3,NUMBER_OF_VERTEX*2);
        private NyARMat wk_transMat_mat_d=new NyARMat( 3, 3 );    
        private double[] wk_transMat_mat_trans=new double[3];
         ...
         */
        public double transMat(NyARSquare square,int i_direction, double width,NyARTransMatResult o_result_conv)
        {
        ...
        private NyARTransMatResult wk_transMatContinue_result=new NyARTransMatResult();
         ...
         * @throws NyARException
         */
        public double transMatContinue(NyARSquare i_square,int i_direction, double i_width,NyARTransMatResult io_result_conv)
        {
        ...
        private NyARMat wk_arGetTransMat3_mat_a=new NyARMat(NUMBER_OF_VERTEX*2,3);
         ...
         * @throws NyARException
         */
        private void arGetTransMat3_initTransMat(double[,] i_ppos3d,double[,] i_ppos2d,double[,] o_pos2d,double[,] o_pos3d,double[] o_off,NyARMat o_mat_b,NyARMat o_mat_d)
        {
...
//	            i_pos_pd_pt=i_ppos3d[i];
        ...
        private NyARMat wk_arGetTransMatSub_mat_c=new NyARMat(NUMBER_OF_VERTEX*2,1);
        private NyARMat wk_arGetTransMatSub_mat_e=new NyARMat( 3, 1 );
        private NyARMat wk_arGetTransMatSub_mat_f=new NyARMat( 3, 1 );
         ...
         * @throws NyARException
         */
        private double arGetTransMatSub(double[,] i_ppos2d,double[,] i_pos3d,NyARMat i_mat_b,NyARMat i_mat_d,double[] o_trans)
        {
	        double[] cpara=param.get34Array();
