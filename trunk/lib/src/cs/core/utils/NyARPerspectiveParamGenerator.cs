...
namespace jp.nyatla.nyartoolkit.cs.core
{
    ...
    public abstract class NyARPerspectiveParamGenerator
    {
         ...
         * @
         */
        public bool getParam(int i_width, int i_height, NyARDoublePoint2d[] i_vertex, double[] o_param)
        {
         ...
         * @
         */
        public abstract bool getParam(int i_dest_w, int i_dest_h, double x1, double y1, double x2, double y2, double x3, double y3, double x4, double y4, double[] o_param);
    }
}