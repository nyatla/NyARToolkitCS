...
namespace jp.nyatla.nyartoolkit.cs.sandbox.x2
{
     ...
     * 
     */
    public class NyARTransMat_X2 : INyARTransMat
    {
        private NyARFixedFloat16Point2d _center = new NyARFixedFloat16Point2d();
        private NyARFixedFloatTransOffset _offset = new NyARFixedFloatTransOffset();
        ...
        public NyARTransMat_X2(NyARParam i_param)
        {
         ...
         * @param o_liner_ref
         */
        private void initVertexOrder(NyARSquare i_square, int i_direction, NyARFixedFloat16Point2d[] o_sqvertex_ref, NyARLinear[] o_liner_ref)
        {
            //頂点順序を考慮した矩形の頂点情報
        ...
        private NyARFixedFloat16Point2d[] __transMat_sqvertex_ref = NyARFixedFloat16Point2d.createArray(4);
        private NyARLinear[] __transMat_linear_ref = new NyARLinear[4];
        private NyARFixedFloat16Point3d __transMat_trans = new NyARFixedFloat16Point3d();
        /**
        ...
        {
            NyARFixedFloat16Point2d[] sqvertex_ref = __transMat_sqvertex_ref;
            NyARLinear[] linear_ref = __transMat_linear_ref;
            NyARFixedFloat16Point3d trans = this.__transMat_trans;
        ...
        public void transMatContinue(NyARSquare i_square, int i_direction, double i_width, NyARTransMatResult io_result_conv)
        {
            ...
            return;*/
            NyARException.trap("notImplement()");
        }
