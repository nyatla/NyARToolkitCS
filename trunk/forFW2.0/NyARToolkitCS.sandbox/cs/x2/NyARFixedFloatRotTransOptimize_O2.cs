...
namespace jp.nyatla.nyartoolkit.cs.sandbox.x2
{
    ...
    {
        private const int AR_GET_TRANS_MAT_MAX_LOOP_COUNT = 1;// #define AR_GET_TRANS_MAT_MAX_LOOP_COUNT 5
        ...
        public double optimize(NyARFixedFloatRotMatrix io_rotmat, NyARFixedFloat16Point3d io_transvec, NyARFixedFloatFitVecCalculator i_calculator)
        {
            NyARFixedFloat16Point2d[] fit_vertex = i_calculator.getFitSquare();
            NyARFixedFloat16Point3d[] offset_square = i_calculator.getOffsetVertex().vertex;
        ...
        private long[][] __modifyMatrix_double1D = ArrayUtils.newLong2dArray(8, 3);
        private NyARFixedFloat16Point3d __modifyMatrix_angle = new NyARFixedFloat16Point3d();
        private long INITIAL_FACTOR = (long)(0x10000 * 5.0 * Math.PI / 180.0);
        /**
         ...
         */
        private double modifyMatrix(NyARFixedFloatRotMatrix io_rot, NyARFixedFloat16Point3d trans, NyARFixedFloat16Point3d[] i_vertex3d, NyARFixedFloat16Point2d[] i_vertex2d)
        {
            long a2, b2, c2;
            long h, x, y;
            long err, minerr = 0;
            ...
            // vertex展開
            long VX00, VX01, VX02, VX10, VX11, VX12, VX20, VX21, VX22, VX30, VX31, VX32;
            VX00 = i_vertex3d[0].x;
            VX01 = i_vertex3d[0].y;
            VX02 = i_vertex3d[0].z;
            VX10 = i_vertex3d[1].x;
            ...
            VX31 = i_vertex3d[3].y;
            VX32 = i_vertex3d[3].z;
            long P2D00, P2D01, P2D10, P2D11, P2D20, P2D21, P2D30, P2D31;
            ...
            long CP0, CP1, CP2, CP3, CP4, CP5, CP6, CP7, CP8, CP9, CP10;
            ...
            long[] b_factor = double1D[4];
            long[] sinc = double1D[5];
            long[] cosc = double1D[6];
            long[] c_factor = double1D[7];
            long w, w2;
            long wsin, wcos;
