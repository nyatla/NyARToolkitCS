...
import jp.nyatla.nyartoolkit.detector.NyARSingleDetectMarker_ARTKv2.ARTKDetector;
...
public abstract class NyARSingleDetectMarker
{
	...
	public sealed static int PF_ARTOOLKIT_COMPATIBLE=1;
	/** NyARToolKitのアルゴリズムを選択します。*/
	public sealed static int PF_NYARTOOLKIT=2;
	/** ARToolKit互換アルゴリズムと、NyARToolKitのアルゴリズムの混合です。2D系にNyARToolkit,3D系にARToolKitのアルゴリズムを選択します。*/
	public sealed static int PF_NYARTOOLKIT_ARTOOLKIT_FITTING=100;
	/** 開発用定数値*/
	public sealed static int PF_TEST2=201;	
	/**
...
class NyARSingleDetectMarker_ARTKv2 : NyARSingleDetectMarker
{
	 ...
	 */
	static class ARTKDetector : NyARSquareContourDetector_ARToolKit
	{
