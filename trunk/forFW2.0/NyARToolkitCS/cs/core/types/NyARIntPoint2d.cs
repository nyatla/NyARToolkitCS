...
public class NyARIntPoint2d
{
	 ...
	 * コピー先の配列
	 */
	public static void copyArray(sealed NyARIntPoint2d[] i_from,NyARIntPoint2d[] i_to)
	{
	 ...
	 */
	public sealed static void makeCenter(NyARIntPoint2d[] i_points,int i_number_of_data,NyARIntPoint2d o_out)
	{
	 ...
	 * i_p1との距離の二乗値
	 */	
	public sealed int sqDist(NyARIntPoint2d i_p1)
	{
		int x=this.x-i_p1.x;
		int y=this.y-i_p1.y;
		return x*x+y*y;
	 ...
	 * 配列中の有効な頂点数です。
	 */	
	public sealed void setCenterPos(NyARIntPoint2d[] i_point,int i_number_of_vertex)
	{
		int cx,cy;
		cx=cy=0;
	 ...
	 * コピー元のオブジェクト。
	 */
	public sealed void setValue(NyARIntPoint2d i_source)
	{
		this.x=i_source.x;
		this.y=i_source.y;
	}
	 ...
	 * コピー元のオブジェクト。
	 */	
	public sealed void setValue(NyARDoublePoint2d i_source)
	{
	 ...
	 * {@link #y}にセットする値
	 */	
	public sealed void setValue(int i_x,int i_y)
	{
		this.x=i_x;
		this.y=i_y;
	}
