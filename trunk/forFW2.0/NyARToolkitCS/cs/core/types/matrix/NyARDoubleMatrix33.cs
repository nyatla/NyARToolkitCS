...
public class NyARDoubleMatrix33 : INyARDoubleMatrix
{
	...
	{
		sealed double a11,a12,a13,a21,a22,a23,a31,a32,a33;
		sealed double b11,b12,b13,b21,b22,b23,b31,b32,b33;	
	 ...
	 *　セットする角度値です。
	 */	
	public sealed void setZXYAngle(NyARDoublePoint3d i_angle)
	{
	 ...
	 *　X軸の角度値
	 */
	public sealed void setZXYAngle(sealed double i_x, sealed double i_y, sealed double i_z)
	{
	 ...
	 * 変換後の座標を受け取るオブジェクト
	 */
	public sealed void transformVertex(NyARDoublePoint3d i_position,NyARDoublePoint3d o_out)
	{
	 ...
	 * 変換後の座標を受け取るオブジェクト
	 */
	public sealed void transformVertex(double i_x,double i_y,double i_z,NyARDoublePoint3d o_out)
	{
