...
public class NyARDoubleMatrix44 : INyARDoubleMatrix
{
	...
	{
		sealed double a11,a12,a13,a14,a21,a22,a23,a24,a31,a32,a33,a34,a41,a42,a43,a44;
		sealed double b11,b12,b13,b14,b21,b22,b23,b24,b31,b32,b33,b34,b41,b42,b43,b44;	
	 ...
	 * 変換後の座標を受け取るオブジェクト
	 */
	public sealed void transform3d(double i_x,double i_y,double i_z,NyARDoublePoint3d o_out)
	{
	 ...
	 * 変換後の座標を受け取るオブジェクト
	 */	
	public sealed void transform3d(NyARDoublePoint3d i_in,NyARDoublePoint3d o_out)
	{
	 ...
	 * 角度値の範囲は、0-PI(要確認)です。
	 */
	public sealed void getZXYAngle(NyARDoublePoint3d o_out)
	{
	 ...
	 * 右成分の行列
	 */
	public sealed void mul(NyARDoubleMatrix44 i_mat_l,NyARDoubleMatrix44 i_mat_r)
	{
		assert(this!=i_mat_l);
		assert(this!=i_mat_r);
	 ...
	 * 設定するX回転角(radian)
	 */
	public sealed void setRotateX(double i_radian)
	{
	 ...
	 * 設定するY回転角(radian)
	 */
	public sealed void setRotateY(double i_radian)
	{
		double s=Math.sin(i_radian);
		double c=Math.cos(i_radian);
		this.identity();
	 ...
	 * 設定するZ回転角(radian)
	 */
	public sealed void setRotateZ(double i_radian)
	{
		double s=Math.sin(i_radian);
		double c=Math.cos(i_radian);
		this.identity();
	 ...
	 * z軸方向の平行移動量
	 */
	public sealed void setTranslate(double i_x,double i_y,double i_z)
	{
		this.identity();
		this.m03=i_x;
		this.m13=i_y;
	 ...
	 * 回転量(radian)
	 */
	public sealed void rotateX(double i_radian)
	{
		double s=Math.sin(i_radian);
		double c=Math.cos(i_radian);
	 ...
	 * 回転量(radian)
	 */
	public sealed void rotateY(double i_radian)
	{
		double s=Math.sin(i_radian);
		double c=Math.cos(i_radian);
	 ...
	 * 回転量(radian)
	 */
	public sealed void rotateZ(double i_radian)
	{
		double s=Math.sin(i_radian);
		double c=Math.cos(i_radian);
	 ...
	 * Z方向の平行移動量
	 */
	public sealed void translate(double i_x,double i_y,double i_z)
	{
