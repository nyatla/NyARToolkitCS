...
public class NyARPointerStack<T>
{
	 ...
	 * 取り除く個数
	 */
	public sealed void pops(int i_count)
	{
	 ...
	 * 配列要素の参照値
	 */
	public sealed T getItem(int i_index)
	{
	 ...
	 * @return
	 */
	public sealed int getArraySize()
	{
