...
public class NyARLinear
{
	 ...
	 * コピー元のオブジェクト
	 */
	public sealed void copyFrom(NyARLinear i_source)
	{
		this.b=i_source.b;
		this.a=i_source.a;
		this.c=i_source.c;
	 ...
	 * 交点が求まればtrue
	 */
	public sealed bool crossPos(NyARLinear l_line_2,NyARDoublePoint2d o_point)
	{
		sealed double w1 = this.a * l_line_2.b - l_line_2.a * this.b;
		if (w1 == 0.0) {
			return false;
		}
	 ...
	 * 交点が求まればtrue
	 */
	public sealed bool crossPos(double i_a,double i_b,double i_c,NyARDoublePoint2d o_point)
	{
		sealed double w1 = this.a * i_b - i_a * this.b;
		if (w1 == 0.0) {
			return false;
		}
	 ...
	 * 交点が求まればtrue
	 */
	public sealed bool crossPos(double i_a,double i_b,double i_c,NyARIntPoint2d o_point)
	{
		sealed double w1 = this.a * i_b - i_a * this.b;
		if (w1 == 0.0) {
			return false;
	 ...
	 * 交差していればtrue
	 */
	public sealed bool isCross(NyARLinear l_line_2)
	{
		sealed double w1 = this.a * l_line_2.b - l_line_2.a * this.b;
	 ...
	 * 直線式が求まれば、true
	 */
	public sealed bool makeLinearWithNormalize(NyARIntPoint2d i_point1,NyARIntPoint2d i_point2)
	{
	 ...
	 * 直線式が求るとtrueを返します。
	 */
	public sealed bool makeLinearWithNormalize(NyARDoublePoint2d i_point1,NyARDoublePoint2d i_point2)
	{
		return makeLinearWithNormalize(i_point1.x,i_point1.y,i_point2.x,i_point2.y);
	}
	/**
	 ...
	 * 直線式が求るとtrueを返します。
	 */
	public sealed bool makeLinearWithNormalize(double x1,double y1,double x2,double y2)
	{
		double dx=y2-y1;
		double dy=x1-x2;
	 ...
	 * 通過点の座標Y
	 */
	public sealed void setVector(double i_dx,double i_dy,double i_x,double i_y)
	{
		this.a= i_dy;
		this.b=-i_dx;
	 ...
	 * セットするオブジェクト
	 */
	public sealed void setVector(NyARVecLinear2d i_vector)
	{
		this.a= i_vector.dy;
		this.b=-i_vector.dx;
	 ...
	 * セットするオブジェクト
	 */
	public sealed bool setVectorWithNormalize(NyARVecLinear2d i_vector)
	{
	 ...
	 */
	public sealed void normalLine(double i_x,double i_y,NyARLinear i_linear)
	{
	 ...
	 * 交点が求まれば、trueを返します。
	 */
	public sealed bool normalLineCrossPos(double i_x,double i_y,NyARLinear i_linear,NyARDoublePoint2d o_point)
	{
		//thisを法線に変換
		double la=this.b;
		double lb=-this.a;
		...
		//交点を計算
		sealed double w1 = i_linear.a * lb - la * i_linear.b;
		if (w1 == 0.0) {
			return false;
		}
...
//	 * 交点が無い場合、無限大を返します。
//	 */
//	public sealed double sqDistWithLinear(NyARLinear i_linear, double i_x,double i_y)
//	{
//		//thisを法線に変換
//		double la=this.b;
//		double lb=-this.a;
...
//	}
	 ...
	 * 端点が求まればtrue
	 */
	public sealed bool makeSegmentLine(int i_width,int i_height,NyARIntPoint2d[] o_point)
	{	
		int idx=0;
	 ...
	 * 端点が求まればtrue
	 */
	public sealed bool makeSegmentLine(int i_left,int i_top,int i_width,int i_height,NyARIntPoint2d[] o_point)
	{	
	 ...
	 */
	public sealed double sqDistBySegmentLineEdge(NyARDoublePoint2d i_sp1,NyARDoublePoint2d i_sp2)
	{
		double la,lb,lc;
		double x,y,w1;
		//thisを法線に変換
