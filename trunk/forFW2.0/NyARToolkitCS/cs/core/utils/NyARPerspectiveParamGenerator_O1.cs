...
namespace jp.nyatla.nyartoolkit.cs.core
{
    ...
    public class NyARPerspectiveParamGenerator_O1 : NyARPerspectiveParamGenerator
    {
        ...
        public NyARPerspectiveParamGenerator_O1(int i_local_x, int i_local_y)
            : base(i_local_x, i_local_y)
	    {
		    return;
	    }

    	
	    public override bool getParam(int i_dest_w,int i_dest_h,double x1,double y1,double x2,double y2,double x3,double y3,double x4,double y4,double[] o_param)
	    {
