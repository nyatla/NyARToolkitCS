...
sealed public class NyARPerspectiveProjectionMatrix : NyARDoubleMatrix44
{
	 ...
	 */
	private sealed static double dot(double a1, double a2, double a3, double b1,double b2, double b3)
	{
		return (a1 * b1 + a2 * b2 + a3 * b3);
	}

	/* static double norm( double a, double b, double c ) */
	private sealed static double norm(double a, double b, double c)
	{
	 ...
	 * 変換後の座標値を受け取るオブジェクト
	 */
	public sealed void project(NyARDoublePoint3d i_3dvertex,NyARDoublePoint2d o_2d)
	{
	 ...
	 * 変換後の座標値を受け取るオブジェクト
	 */
	public sealed void project(double i_x,double i_y,double i_z,NyARDoublePoint2d o_2d)
	{
	 ...
	 * 変換後の座標値を受け取るオブジェクト
	 */
	public sealed void project(NyARDoublePoint3d i_3dvertex,NyARIntPoint2d o_2d)
	{
		double w=1/(i_3dvertex.z*this.m22);
	 ...
	 * 変換後の座標値を受け取るオブジェクト
	 */
	public sealed void project(double i_x,double i_y,double i_z,NyARIntPoint2d o_2d)
	{
		double w=1/(i_z*this.m22);
