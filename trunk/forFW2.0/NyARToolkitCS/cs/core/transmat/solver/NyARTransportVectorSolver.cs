...
public class NyARTransportVectorSolver : INyARTransportVectorSolver
{
	...
	{
		sealed int number_of_vertex=this._nmber_of_vertex;
		sealed double p00=this._projection_mat.m00;
		sealed double p01=this._projection_mat.m01;
		sealed double p02=this._projection_mat.m02;
		sealed double p11=this._projection_mat.m11;
		sealed double p12=this._projection_mat.m12;
		//行列[A]の3列目のキャッシュ
		sealed double[] cx=this._cx;
		sealed double[] cy=this._cy;			
