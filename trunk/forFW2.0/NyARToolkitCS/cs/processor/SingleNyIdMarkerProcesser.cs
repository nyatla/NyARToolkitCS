...
public abstract class SingleNyIdMarkerProcesser
{
	...
	{
		//公開プロパティ
		public sealed NyARSquare square=new NyARSquare();
		...
		private sealed NyIdMarkerPickup _id_pickup;
		...
		private sealed NyIdMarkerParam _marker_param=new NyIdMarkerParam();
		private sealed NyIdMarkerPattern _marker_data=new NyIdMarkerPattern();
	...
	public void detectMarker(INyARRgbRaster i_raster)
	{
		...
		sealed bool is_id_found=updateStatus(this._square_detect.square,this._square_detect.marker_data);
