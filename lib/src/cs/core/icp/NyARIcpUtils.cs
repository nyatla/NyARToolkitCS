...
namespace jp.nyatla.nyartoolkit.cs.core
{
    ...
    {
        public class U : NyARDoublePoint2d
        {
            /**
        ...
        public class JusStack : NyARObjectStack<JusStack.Item>
        {
            public JusStack(int i_length):base(i_length)
            {
                return;
            }
            /**
             * この関数は、配列要素を作成します。
             */
            protected override JusStack.Item createElement()
            {
                return new Item();
            }
            public class Item
            ...
            private double[][] __J_Xc_S = ArrayUtils.newDouble2dArray(3, 6);
        ...
        public class DeltaS
        {
             ...
             */
            public bool setJusArray(NyARIcpUtils.JusStack i_jus)
            {
        ...
        class IcpMat44 : NyARDoubleMatrix44
        {
