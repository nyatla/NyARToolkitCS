...
public class NyARRgbRaster_BYTE1D_X8R8G8B8_32 : NyARRgbRaster
{
	protected byte[] _buf;
	public NyARRgbRaster_BYTE1D_X8R8G8B8_32(int i_width, int i_height,boolean i_is_alloc) {
	...
	sealed public int[] getPixel(int i_x, int i_y, int[] o_rgb)
	{
		...
		const int bp = (i_x + i_y * this._size.w) * 4;
