...
namespace jp.nyatla.nyartoolkit.cs.core
{
    ...
    {
        readonly public int num_of_iset;
        readonly public byte[] image;
        readonly public float image_dpi_x;
        readonly public float image_dpi_y;
        readonly public int image_unit;
        readonly public NyARIntSize image_size;
        /** サブ画像のdpiセット*/
        readonly public float[] sub_dpis;
