...
namespace jp.nyatla.nyartoolkit.cs.core
{
     ...
     */
    public class NyARCameraDistortionFactorV4 : NyARCameraDistortionFactorImpl
    {
        public const int NUM_OF_FACTOR = 9;
        readonly private double _k1;
        readonly private double _k2;
        readonly private double _p1;
        readonly private double _p2;
        readonly private double _fx;
        readonly private double _fy;
        readonly private double _x0;
        readonly private double _y0;
        readonly private double _s;
