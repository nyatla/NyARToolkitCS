...
namespace jp.nyatla.nyartoolkit.cs.core
{
    ...
    public class FREAKExtractor
    {
         ...
         */
        private const int freak84_num_receptors = 37;

        /**
         * Total number of rings. This does not include the center receptor.
         */
        private const int freak84_num_rings = 6;

        /**
         * Total number of receptor per ring.
         */
        private const int freak84_num_receptors_per_ring = 6;

        /**
         * SIGMA value for the center receptor and the receptors in all the rings.
         */

        private const double freak84_sigma_center = 0.100000f;
        private const double freak84_sigma_ring0 = 0.175000f;
        private const double freak84_sigma_ring1 = 0.250000f;
        private const double freak84_sigma_ring2 = 0.325000f;
        private const double freak84_sigma_ring3 = 0.400000f;
        private const double freak84_sigma_ring4 = 0.475000f;
        private const double freak84_sigma_ring5 = 0.550000f;

        /**
         * (x,y) locations of each receptor in the ring.
         */

        readonly private static double[] freak84_points_ring0 = {
		0.000000f, 0.362783f,	-0.314179f, 0.181391f,
		-0.314179f, -0.181391f, -0.000000f,-0.362783f,
		0.314179f, -0.181391f, 0.314179f, 0.181391f };
        readonly private static double[] freak84_points_ring1 = { -0.595502f,
			0.000000f, -0.297751f, -0.515720f, 0.297751f, -0.515720f,
			0.595502f, -0.000000f, 0.297751f, 0.515720f, -0.297751f, 0.515720f };
        readonly private static double[] freak84_points_ring2 = { -0.000000f,
			-0.741094f, 0.641806f, -0.370547f, 0.641806f, 0.370547f, 0.000000f,
			0.741094f, -0.641806f, 0.370547f, -0.641806f, -0.370547f };
        readonly private static double[] freak84_points_ring3 = { 0.847306f,
			-0.000000f, 0.423653f, 0.733789f, -0.423653f, 0.733789f,
			-0.847306f, 0.000000f, -0.423653f, -0.733789f, 0.423653f,
			-0.733789f };
        readonly private static double[] freak84_points_ring4 = { 0.000000f, 0.930969f,
			-0.806243f, 0.465485f, -0.806243f, -0.465485f, -0.000000f,
			-0.930969f, 0.806243f, -0.465485f, 0.806243f, 0.465485f };
        readonly private static double[] freak84_points_ring5 = { -1.000000f,
			0.000000f, -0.500000f, -0.866025f, 0.500000f, -0.866025f,
			1.000000f, -0.000000f, 0.500000f, 0.866025f, -0.500000f, 0.866025f };

        // Receptor locations
        readonly private double[] mPointRing0 = new double[12];
        readonly private double[] mPointRing1 = new double[12];
        readonly private double[] mPointRing2 = new double[12];
        readonly private double[] mPointRing3 = new double[12];
        readonly private double[] mPointRing4 = new double[12];
        readonly private double[] mPointRing5 = new double[12];
        ...
        private void CopyVector(double[] out_, double[] in_, int len)
        {
            //		System.arraycopy(in_, 0, out_, 0, len);
            System.Array.Copy(in_, out_, len);
        }
        ...
        void CompareFREAK84(byte[] desc, double[] samples)
        {
            ...
            for (int i = 0; i < 37; i++)
            {
                for (int j = i + 1; j < 37; j++)
                {
                    ...
                    {
                        desc[(pos / 8)] |= (byte)(1 << (pos % 8));
                    }
                    else
                    {
                        desc[(pos / 8)] |= (byte)(0 << (pos % 8));
                    }
                    pos++;
                }
            }
        ...
        {
            System.Console.WriteLine("FreakExtructor stack overflow");
        }
