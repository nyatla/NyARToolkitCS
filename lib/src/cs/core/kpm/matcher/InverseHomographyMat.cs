...
namespace jp.nyatla.nyartoolkit.cs.core
{
    ...
    public class InverseHomographyMat : NyARDoubleMatrix33
    {
         ...
         * @return
         */
        virtual public bool checkHomographyHeuristics(int refWidth, int refHeight)
        {
         ...
         */
        private static bool QuadrilateralConvex(NyARDoublePoint2d x1, NyARDoublePoint2d x2, NyARDoublePoint2d x3, NyARDoublePoint2d x4)
        {
            int s;
