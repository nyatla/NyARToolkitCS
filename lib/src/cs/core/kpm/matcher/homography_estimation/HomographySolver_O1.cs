...
namespace jp.nyatla.nyartoolkit.cs.core
{
     ...
     */
    sealed public class HomographySolver_O1 : HomographySolver
    {
        private double[][] _mat_A = ArrayUtils.newDouble2dArray(8, 9);
        ...
        private readonly NyARDoublePoint2d[] _a1 = new NyARDoublePoint2d[4];
        private readonly NyARDoublePoint2d[] _a2 = new NyARDoublePoint2d[4];
        ...
        public static bool OrthogonalizePivot8x9Basis(double[][] dest, int line, double[][] a)
        {
            int p = 7 - line;
            int index = 0;
            double ss = 0;
        ...
        private readonly double[] _OrthogonalizeIdentity8x9_X = new double[9];
        ...
        private readonly double[][] _solveNullVector8x9Destructive_Q = ArrayUtils.newDouble2dArray(8, 9);
        /**
