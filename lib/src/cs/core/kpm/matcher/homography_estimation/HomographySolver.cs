...
namespace jp.nyatla.nyartoolkit.cs.core
{
    ...
    {
        protected const double SQRT2 = NyARMath.SQRT2;
...
//		xp1.setValue(10, 10);xp2.setValue(10, 0);xp3.setValue(0, 0);xp4.setValue(0, 10);		
         ...
         * @{
         */
        private static bool OrthogonalizePivot8x9Basis0(double[][] Q, double[][] A)
        {
            int index = 0;
            double ss = 0;
            for (int i = 7; i >= 0; i--)
        ...
        private static bool OrthogonalizePivot8x9Basis1(double[][] Q, double[][] A)
        {
            int index = 0;
            double ss = 0;
            for (int i = 6; i >= 0; i--)
        ...
        private static bool OrthogonalizePivot8x9Basis2(double[][] Q, double[][] A)
        {
            int index = 0;
            double ss = 0;
            for (int i = 5; i >= 0; i--)
        ...
        private static bool OrthogonalizePivot8x9Basis3(double[][] Q, double[][] A)
        {
            int index = 0;
            double ss = 0;
            for (int i = 4; i >= 0; i--)
        ...
        private static bool OrthogonalizePivot8x9Basis4(double[][] Q, double[][] A)
        {
            int index = 0;
            double ss = 0;
            for (int i = 3; i >= 0; i--)
        ...
        private static bool OrthogonalizePivot8x9Basis5(double[][] Q, double[][] A)
        {
            int index = 0;
            double ss = 0;
            for (int i = 2; i >= 0; i--)
        ...
        private static bool OrthogonalizePivot8x9Basis6(double[][] Q, double[][] A)
        {
        ...
        private static bool OrthogonalizePivot8x9Basis7(double[][] Q, double[][] A)
        {
